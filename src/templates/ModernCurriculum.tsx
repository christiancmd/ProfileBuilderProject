    ...
    <div className="p-10 space-y-10">
      ...
      <header className="text-center pb-4 border-b-4 border-blue-600/70">
        ...
        <p className="text-xl font-light text-blue-700 mt-2">
          {title ? title : "Arquitecto de Software & Desarrollador Full Stack"}
        </p>
          ...
          <section>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc text-sm text-gray-700 space-y-1 ml-5 mt-2">
                <li>
                  Lideré la migración de un monolito a una arquitectura de **15+
                  Microservicios** basados en AWS, reduciendo la latencia de
                  respuesta en un 40%.
                </li>
                <li>
                  Diseñé e implementé la estrategia de CI/CD utilizando **GitHub
                  Actions** y **Terraform**.
                </li>
                <li>
                  Mentoricé a un equipo de 6 desarrolladores Full Stack en
            ...
            <div className="mb-4">
              ...
              <ul className="list-disc text-sm text-gray-700 space-y-1 ml-5 mt-2">
                <li>
                  Desarrollé la interfaz de usuario con React y Redux, mejorando
                  la experiencia de usuario (UX) en el proceso de checkout.
                </li>
                <li>
                  Optimicé consultas SQL complejas, lo que resultó en una mejora
                  del 25% en el tiempo de carga de informes críticos.
                </li>
              </ul>
            </div>
          </section>
        ...
        <section>
          ...
          <div className="text-base text-gray-700 leading-relaxed space-y-2">
            ...
            <p>
              ...
              Liderazgo de equipos, Gestión de Proyectos, Comunicación efectiva,
